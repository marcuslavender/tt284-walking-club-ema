...
?>
        ...
        <div class="form">
        <form method="post" action="<?php echo htmlspecialchars("https://zy202824.tt284.open.ac.uk/emafiles/submit_to_database_new.php");?>"  name="submit_a_walk">
        <label  for="name_of_walk">Name of Walk:</label>
        <input type="text" name="Name_of_walk" id="name_of_walk" placeholder="Walk name:" tabindex="4" pattern='[A-Za-z0-9-\s{0-30}]+' autofocus class="input" required>
        
        <label for="date">Date:</label>
        <input type="text" name="Date" id="date" tabindex="5" class="input" required>
        ...
        <input type="text" name="Meeting_point_latlong" id="meeting_point_latlong" placeholder="coordinates"  tabindex="7" class="input" required>
        
        <label for="meeting_point">Meeting point:</label>
        <input type="text" name="Meeting_point" id="meeting_point" placeholder="Meeting Point:"  tabindex="8" class="input" required>
        
        <label for="distance">Distance:</label>
        <input type="text" name="Distance" id="distance" placeholder="in miles:"  tabindex="9" class="input" required>
        
        <label for="route">Route:</label>
        <input type="text" name="Route" id="route"  placeholder="Enter Route:"  maxlength="500"  tabindex="10" class="input"> <!-- Need to pattern/Regex -->
        
        <label for="notes">Notes:</label>
        <input type="text" name="Notes" id="notes" placeholder="Any Notes?:"  maxlength="500"  tabindex="11"  class="input">
